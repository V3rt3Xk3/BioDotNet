...
public class ProteinSequence : Sequence
{
    /// <summary>
    ...
    public ProteinSequence(IAlphabet alphabet, string sequence)
    ...
    public ProteinSequence(IAlphabet alphabet, char[] values)
    ...
    public ProteinSequence(ProteinSequence newSequence) : base(newSequence) { }
}
