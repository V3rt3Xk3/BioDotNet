...
internal class RnaSequence : NucelicAcidSequence
{
    /// <summary>
    ...
    public RnaSequence(IAlphabet alphabet, string sequence)
    ...
    public RnaSequence(IAlphabet alphabet, char[] values)
    ...
    public RnaSequence(RnaSequence newSequence) : base(newSequence) { }
}
