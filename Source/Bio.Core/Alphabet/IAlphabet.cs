...
/// </para>
/// </summary>
public interface IAlphabet : IEnumerable<char>
{
    /// <summary>
    ...
    /// <returns>A char which represents the symbol.</returns>
    ...
    bool TryGetComplementSymbol(char symbol, out char complementSymbol);
    ...
    /// <returns>Returns true if complement symbol is found and returned, else returns false.</returns>
    bool TryGetComplementSymbol(char[] symbols, out char[] complementSymbols);
    ...
    bool TryGetDefaultGapSymbol(out char defaultGapSymbol);
    ...
    bool TryGetDefaultTerminationSymbol(out char defaultTerminationSymbol);
    ...
    bool TryGetGapSymbols(out HashSet<char> gapSymbols);
    ...
    bool TryGetTerminationSymbols(out HashSet<char> terminationSymbols);
    ...
    /// </summary>
    HashSet<char> GetValidSymbols();

    /// <summary>
    /// Gets the ambiguous symbols present in alphabet.
    /// </summary>
    HashSet<char> GetAmbiguousSymbols();
    ...
    /// </summary>
    Dictionary<char,char> GetSymbolValueMap();
    ...
    char GetConsensusSymbol(HashSet<char> symbols);
    ...
    bool TryGetAmbiguousSymbol(HashSet<char> symbols, out char ambiguousSymbol);
    ...
    bool TryGetBasicSymbols(char ambiguousSymbol, out HashSet<char> basicSymbols);

    /// <summary>
    /// Compares two items and specifies whether they are same or not.
    /// If the any of the chars (Nucleotides) passed not belongs to
    ...
    bool CompareSymbols(char x, char y);
    ...
    bool ValidateSequence(char[] symbols, long offset, long length);
    ...
    bool CheckIsAmbiguous(char item);
    ...
    string GetFriendlyName(char item);
}