...
public class RnaAlphabet : IAlphabet
{
    ...
    {
        this.Name = Resource.RnaAlphabetName;
        this.HasGaps = true;
        ...
        basicSymbols.Add(this.A); basicSymbols.Add((char)char.ToLower((char)this.A));
        basicSymbols.Add(this.C); basicSymbols.Add((char)char.ToLower((char)this.C));
        basicSymbols.Add(this.G); basicSymbols.Add((char)char.ToLower((char)this.G));
        basicSymbols.Add(this.U); basicSymbols.Add((char)char.ToLower((char)this.U));
        basicSymbols.Add(this.Gap);

        // Add nucleotides
        this.AddNucleotide(this.A, "Adenine", (char)'a');
        this.AddNucleotide(this.C, "Cytosine", (char)'c');
        this.AddNucleotide(this.G, "Guanine", (char)'g');
        this.AddNucleotide(this.U, "Uracil", (char)'u');
    ...
    public Dictionary<char, char> GetSymbolValueMap()
    {
        ...
        foreach (KeyValuePair<char, char> mapping in this.nucleotideValueMap)
        {
    ...
    protected void MapAmbiguousNucleotide(char ambiguousNucleotide, params char[] nucleotidesToMap)
    {
        ...
        char[] mappingValues = new char[nucleotidesToMap.Length];
        int i = 0;
